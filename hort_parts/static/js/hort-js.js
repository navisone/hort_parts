(function () {
    ...
    window.require = (function e(t, n, r) {
        function s(o, u) {
            if (!n[o]) {
                if (!t[o]) {
        ...
        "jquery/dist/jquery.js": [function (require, module, exports) {
        ...
        "kwf/commonjs/on-ready.js": [function (require, module, exports) {
            var $ = require("jQuery");
            ...
            var readyElHandlers = [];
            var onReadyState;
            var deferredStart = null;
            var onReadyIsCalling = false;
            var onReadyElQueue = [];
            var elCacheBySelector = {};
            var deferHandlerNum = null;
            var addReadyHandler = function (onAction, selector, fn, options) {
                if (!options) options = {};
                if (typeof options.defer == "undefined") options.defer = true;
                readyElHandlers.push({
                    selector: selector,
                    fn: fn,
                    options: options,
                    num: readyElHandlers.length,
                    onAction: onAction
                });
            ...
            var callOnContentReady = function (renderedEl, options) {
                ...
                if (renderedEl.dom) renderedEl = renderedEl.dom;
                if (renderedEl.jquery) {
                    renderedEl.each(function () {
                        callOnContentReady(this, options)
                    });
                    return
                }
                var onActions;
                ...
                for (var i = 0; i < readyElHandlers.length; i++) {
                    ...
                    if (useSelectorCache && elCacheBySelector[hndl.selector] && !elCacheBySelector[hndl.selector].dirty) {
                        ...
                        for (var j = 0; j < elCacheBySelector[hndl.selector].length; j++) {
                            if (renderedEl == document.body || renderedEl == elCacheBySelector[hndl.selector][j] || $.contains(renderedEl, elCacheBySelector[hndl.selector][j])) {
                ...
                function callQueueFn(queueEntry, config) {
                    ...
                    benchmarkBox.subTime("on" + queueEntry.onAction.charAt(0).toUpperCase() + queueEntry.onAction.slice(1), "fn: " + fnName, benchmarkBox.now() - t)
                }
                ...
                if (onReadyState == "callDefer") {
                    var processNext = function processNext() {
                        ...
                        if (onReadyElQueue.length) {
                            ...
                            benchmarkBox.create({type: "onReady defer"})
                        }
                    };
                    processNext()
                } else {
            ...
            $(document).ready(function () {
                if ($(document.body).is(".vw5-frontend")) {
                    if (!document.body) {
                        return
                    }
                    var t = benchmarkBox.now();
                    ...
                    benchmarkBox.create({type: "onReady"});
                    setTimeout(function () {
            ...
            "kwf/benchmark/box": "kwf/commonjs/benchmark/box.js",
            "kwf/element/is-visible": "kwf/commonjs/element/is-visible.js",
            "matches-selector": "matches-selector/matches-selector.js"
        }],
        ...
        }, {"jQuery": "jquery/dist/jquery.js", "kwf/benchmark/box": "kwf/commonjs/benchmark/box.js"}],
        "kwf/commonjs/benchmark/box.js": [function (require, module, exports) {
            var $ = require("jQuery");
            var BenchmarkBox = {};
            ...
            if (!benchmarkEnabled) {
                ...
                var setCookie = function (name, value) {
                    var argv = arguments, argc = arguments.length, expires = argc > 2 ? argv[2] : null,
                        path = argc > 3 ? argv[3] : "/", domain = argc > 4 ? argv[4] : null,
                ...
                BenchmarkBox.subTime = function (name, subName, duration) {
                    ...
                    if (!BenchmarkBox._subTimers[name][subName]) {
                        BenchmarkBox._subTimers[name][subName] = {count: 0, duration: 0}
                    }
                ...
                BenchmarkBox.initBox = function (el) {
                    ...
                    el.initDone = true;
                    var container = $(".vw5-benchmarkContainer");
                    if (!container.length) {
                        container = $('<div class="vw5-benchmarkContainer"></div>');
                        $("body").append($(container))
                    }
                    container.append($(el));
                    var benchmarkType = $(el).data("benchmarkType");
                    if (getCookie("vw5-benchmarkBox-" + benchmarkType) == "1") {
                        $(el).addClass("visible")
                    }
                    ...
                    showLink.on("click", function (ev) {
                        ...
                        if (!el.parent().hasClass("visible")) {
                            ...
                            setCookie("vw5-benchmarkBox-" + benchmarkType, "1")
                        } else {
                            el.parent().removeClass("visible");
                            setCookie("vw5-benchmarkBox-" + benchmarkType, "0")
                        }
                    })
                };
                BenchmarkBox.create = function (options) {
                    ...
                    for (var name in BenchmarkBox._subTimers) {
                        ...
                        for (var subName in st) {
                            subArray.push({count: st[subName].count, duration: st[subName].duration, name: subName})
                        }
                        html += name + "<br />";
                    ...
                    BenchmarkBox._timers = {};
                    BenchmarkBox._subTimers = {};
                    html = '<div class="vw5-benchmarkBoxContent">' + html + "</div>";
                    html = '<div class="vw5-benchmarkBox" data-benchmark-type="' + options.type + '">' + html + "</div>";
                    var el = $(html);
                    $("body").append(el);
                ...
                $(function () {
                    setTimeout(function () {
                        $("body").find(".vw5-benchmarkBox").each(function (i, el) {
                            BenchmarkBox.initBox($(el))
                        })
                    }, 10)
                })
        ...
        "Kwf_Assets_CommonJs_JQueryPluginDecoratorDependency(jquery-selectric/public/jquery.selectric.js)": [function (require, module, exports) {
            var jQuery = require('jQuery');
            (function ($) {
                "use strict";
                var pluginName = "selectric",
                    classList = "Input Items Open Disabled TempShow HideSelect Wrapper Hover Responsive Above Scroll Group GroupLabel",
                    bindSufix = ".sl", defaults = {
                        ...
                        allowWrap: true,
                        customClass: {prefix: pluginName, camelCase: false, overwrite: true},
                        ...
                        replaceDiacritics: function (s) {
                            var d = "40-46 50-53 54-57 62-70 71-74 61 47 77".replace(/\d+/g, "\\3$&").split(" "),
                                k = d.length;
                            while (k--) s = s.toLowerCase().replace(RegExp("[" + d[k] + "]", "g"), "aeiouncy".charAt(k));
                            return s
                        }, format: function (f) {
                            var a = arguments;
                    ...
                    }, $doc = $(document), $win = $(window), Selectric = function (element, opts) {
                        var _this = this, $original = $(element), $input, $items, $itemsScroll, $wrapper, $label,
                            $outerWrapper, $li, isOpen = false, isEnabled = false, selected, currValue, itemsHeight,
                            itemsInnerHeight, finalWidth, optionsLength, eventTriggers,
                            isMobile = /android|ip(hone|od|ad)/i.test(navigator.userAgent),
                            tabindex = $original.prop("tabindex"), labelBuilder;
                        ...
                        function _init(opts) {
                            ...
                            _destroy(true);
                            var customClass = _this.options.customClass, postfixes = classList.split(" "),
                            ...
                            eventTriggers = {open: _open, close: _close, destroy: _destroy, refresh: _refresh, init: _init};
                        ...
                        function _populate() {
                            _this.items = [];
                            var $options = $original.children(), _$li = "<ul>",
                                selectedIndex = $options.filter(":selected").index(), currIndex = 0;
                            currValue = selected = ~selectedIndex ? selectedIndex : 0;
                            if (optionsLength = $options.length) {
                                $options.each(function () {
                                    var $elm = $(this);
                                    if ($elm.is("optgroup")) {
                                        var groupDisabled = $elm.prop("disabled"), $children = $elm.children();
                                        _$li += _utils.format('<ul class="{1}"><li class="{2}">{3}</li>', $.trim([_this.classes.group, groupDisabled ? "disabled" : "", $elm.prop("class")].join(" ")), _this.classes.grouplabel, $elm.prop("label"));
                                        if (groupDisabled) {
                                    ...
                                    function buildOption() {
                                        var $elm = $(this), optionText = $elm.html(),
                                        ...
                                        _$li += _utils.format('<li data-index="{1}" class="{2}">{3}</li>', currIndex, $.trim([currIndex == currValue ? "selected" : "", currIndex == optionsLength - 1 ? "last" : "", selectDisabled ? "disabled" : ""].join(" ")), $.isFunction(itemBuilder) ? itemBuilder(_this.items[currIndex], $elm, currIndex) : _utils.format(itemBuilder, _this.items[currIndex]));
                                        currIndex++
                                    }
                                });
                                $items.append($itemsScroll.html(_$li + "</ul>"));
                                $label.html($.isFunction(labelBuilder) ? labelBuilder(_this.items[currValue]) : _utils.format(labelBuilder, _this.items[currValue]))
                            }
                            $wrapper.add($original).add($outerWrapper).add($input).off(bindSufix);
                            $outerWrapper.prop("class", [_this.classes.wrapper, _this.options.customClass.overwrite ? $original.prop("class").replace(/\S+/g, _this.options.customClass.prefix + "-$&") : $original.prop("class"), _this.options.responsive ? _this.classes.responsive : ""].join(" "));
                        ...
                        function _calculateOptionsDimensions() {
                            var hiddenChildren = $items.closest(":visible").children(":hidden").addClass(_this.classes.tempshow),
                                maxHeight = _this.options.maxHeight, itemsWidth = $items.outerWidth(),
                        ...
                        function _close() {
                            ...
                            if (currValue != selected) {
                                ...
                                $label.html($.isFunction(labelBuilder) ? labelBuilder(_this.items[selected]) : _utils.format(labelBuilder, _this.items[selected]));
                        ...
                        function _detectItemVisibility(index) {
                            var liHeight = $li.eq(index).outerHeight(), liTop = $li[index].offsetTop,
                                itemsScrollTop = $itemsScroll.scrollTop(), scrollT = liTop + liHeight * 2;
        ...
        "web/themes/Theme/Web.js": [function (require, module, exports) {
            var $ = require("jQuery");
            var onReady = require("kwf/on-ready");
            var selectric = require("kwf-jquery-plugin/jquery-selectric");
            onReady.onRender(".vw5-webForm", function (el) {
            ...
            onReady.onContentReady(function (el, options) {
                if (options.action == "render" && $(el).is("select")) {
                    $(el).selectric("refresh")
                }
                $.each($(".vw5-note"), function (index, note) {
                    var i = index + 1;
                    note = $(note);
                    if (note.data("text").length > 0) {
                        note.html("<span>" + i + "</span>");
                        note.after('<div class="vw5-disclaimer">' + '<div class="vw5-disclaimer__container">' + '<div class="vw5-disclaimer__text"><span class="vw5-sup">' + i + " </span>" + note.data("text") + "</div>" + '<span class="vw5-disclaimer__icon"></span>' + "</div>" + "</div>")
                    }
                    note.on("click", function (e) {
                        $(".vw5-disclaimer").removeClass("active");
                        note.next(".vw5-disclaimer").addClass("active")
                    })
                });
                $(".vw5-disclaimer__icon").on("click", function (e) {
                    $(".vw5-disclaimer").removeClass("active")
                })
            });
            ...
            "jQuery": "jquery/dist/jquery.js",
            "kwf-jquery-plugin/jquery-selectric": "Kwf_Assets_CommonJs_JQueryPluginDecoratorDependency(jquery-selectric/public/jquery.selectric.js)",
            "kwf/on-ready": "kwf/commonjs/on-ready.js"
        }],
        "Root_DomainAt_Component-master-js": [function (require, module, exports) {
            var $ = require("jQuery");
            var onReady = require("kwf/on-ready");
            var stickyContainer = null;
            var setScrollTopForFixedElements = function (el) {
                if (el.find(".vw5-rootDomainAtMaster__page").length && $(window).scrollTop() <= el.find(".vw5-rootDomainAtMaster__page").offset().top && $("body").hasClass("vw5-dealerPageV2")) {
                    ...
                    $.each(el.find(".vw5-moveOnCookieBanner"), function (i, elem) {
                        $(elem).css("top", el.find(".vw5-rootDomainAtMaster__page").offset().top - windowScrollTop).css("transition", "").addClass("vw5-visible")
                    })
                } else {
                    el.find(".vw5-moveOnCookieBanner").css("top", 0).addClass("vw5-visible")
                }
            };
            var fixedElsMovedByCookieBannerDone = false;
            var fixedElsMoveByCookieBanner = function (el) {
            };
            var setScrollTopForFixedContainer = function () {
                if ($('body[class*="__Accessories_Component"]').length && $(window).width() <= 768) return;
                if ($(window).scrollTop() > stickyContainer.data("fixed-offset")) {
                    stickyContainer.addClass("vw5-stickyContainer--sticky");
                    $(".vw5-masterContent").css("padding-top", stickyContainer.height())
                } else {
                    stickyContainer.removeClass("vw5-stickyContainer--sticky");
                    $(".vw5-masterContent").css("padding-top", "")
                }
                if ($(window).scrollTop() < 0) {
                    $(".vw5-rootDomainAtMaster__content").hide().show(0)
                }
            };
            onReady.onRender(".vw5-rootDomainAtMaster", function (el) {
                stickyContainer = $(".vw5-rootDomainAtMaster__stickyContainer");
                $("body").prepend($(".vw5-statisticsOptBox"));
                if ($(window).width() >= 768) {
                    $(window).on("scroll", function () {
                        setScrollTopForFixedElements(el)
                    })
                }
                setScrollTopForFixedElements(el);
                $(window).on("scroll touchmove", function () {
                    if (setScrollTopForFixedContainer) setScrollTopForFixedContainer()
                })
            });
            onReady.onResize(".vw5-rootDomainAtMaster", function (el) {
                if (stickyContainer && stickyContainer.data("fixed-offset") == undefined) {
                    if (stickyContainer.length) {
                        stickyContainer.css("position", "relative");
                        stickyContainer.data("fixed-offset", stickyContainer.offset().top);
                        stickyContainer.css("position", "")
                    }
                }
                if ($("body").hasClass("vw5-showCookieBanner")) {
                    fixedElsMoveByCookieBanner(el)
                }
                setScrollTopForFixedElements(el);
                if (setScrollTopForFixedContainer) setScrollTopForFixedContainer()
            });
        ...
        }, {"jQuery": "jquery/dist/jquery.js", "kwf/on-ready": "kwf/commonjs/on-ready.js"}],
        "TextImage_Component-js": [function (require, module, exports) {


        }, {}],
        "Theme_BasicHeadline_Component-js": [function (require, module, exports) {
            var $ = require("jQuery");
            var onReady = require("kwf/on-ready");
            onReady.onRender(".vw5-themeBasicHeadline", function (el) {
                if (el.hasClass("vw5-showInAnchorBar")) {
                    el.before('<div id="' + el.attr("id") + '" class="vw5-anchor" style="position: absolute; margin-top: -20px"><div>');
                    el.attr("id", "")
                }
            });
        ...
        "Theme_BasicTable_Component-js": [function (require, module, exports) {
            var onReady = require("kwf/on-ready");
            onReady.onResize(".vw5-themeBasicTable.responsiveFlipScroll", function (el) {
                ...
                if (el.width() < el.children("table").width() && !el.hasClass("flipScroll")) {
                    ...
                    if (!el.flipScrollSetAt) {
                        el.children("tbody").on("scroll", function (ev) {
                            addArrow($(this).closest(".vw5-themeBasicTable"))
                        })
                    }
        ...
        "Theme_FormDynamic_Paragraphs_Component-js": [function (require, module, exports) {
            var $ = require("jQuery");
            var onReady = require("kwf/on-ready");
            onReady.onRender(".vw5-themeFormDynamicParagraphs", function (el) {
                el.find("input, textarea").css("width", "")
            });


        }, {"jQuery": "jquery/dist/jquery.js", "kwf/on-ready": "kwf/commonjs/on-ready.js"}],
        "Models_FindModel_Headline_Component-js": [function (require, module, exports) {
            var $ = require("jQuery");
            var onReady = require("kwf/on-ready");
            onReady.onRender(".vw5-modelsFindModelHeadline", function (el) {
                if (el.hasClass("vw5-showInAnchorBar")) {
                    el.before('<div id="' + el.attr("id") + '" class="vw5-anchor" style="position: absolute; margin-top: -20px"><div>');
                    el.attr("id", "")
                }
        ...
        "E18_Embed_Component-js": [function (require, module, exports) {
            "use strict";
            var $ = require("jQuery");
            var onReady = require("kwf/on-ready");
            var BaseUrl = require("kwf/base-url");
            onReady.onRender(".vw5-e18EmbedMaster", function (el) {
                $.ajaxPrefilter(function (options) {
                    if (options.url.substr(0, 1) == "/") {
                        options.url = el.data("vw5-base-url") + options.url;
                        options.withCredentials = true
                    }
                });
                BaseUrl.set(el.data("vw5-base-url"))
            });


        }, {
            "jQuery": "jquery/dist/jquery.js",
            "kwf/base-url": "kwf/commonjs/base-url.js",
            "kwf/on-ready": "kwf/commonjs/on-ready.js"
        }],
        "E18Legacy_Embed_Component-js": [function (require, module, exports) {
            "use strict";
            var $ = require("jQuery");
            var onReady = require("kwf/on-ready");
            var BaseUrl = require("kwf/base-url");
            onReady.onRender(".vw5-e18LegacyEmbedMaster", function (el) {
                $.ajaxPrefilter(function (options) {
                    if (options.url.substr(0, 1) == "/") {
                        options.url = el.data("vw5-base-url") + options.url;
                        options.withCredentials = true
        ...
        "Theme_Boxes_FooterLinks_Component-js": [function (require, module, exports) {
            var $ = require("jQuery");
            var onReady = require("kwf/on-ready");
            onReady.onRender(".vw5-themeBoxesFooterLinks", function (el) {
                var otherPages = el.find(".vw5-themeBoxesFooterLinks__otherPages");
                var bottomLinks = el.find(".vw5-themeBoxesFooterLinks__links");
                bottomLinks.toggleClass("closed");
                otherPages.on("click", function (ev) {
                    bottomLinks.toggleClass("closed");
                    otherPages.toggleClass("open")
                });
                var jumpToTop = el.find(".vw5-themeBoxesFooterLinks__jumpToTop");
                jumpToTop.click(function (ev) {
                    ev.preventDefault();
                    if ($(this).hasClass("disabled")) return;
                    $("html, body").animate({scrollTop: 0}, 800)
                });
                var disableScrollingLinks = function () {
                    if ($(window).scrollTop() == 0 || el.parents(".vw5-frontend").height() <= $(window).height()) {
                        jumpToTop.addClass("disabled")
                    } else {
                        jumpToTop.removeClass("disabled")
                    }
                };
                var scrollTimeout;
                $(window).scroll(function () {
                    ...
                    scrollTimeout = setTimeout(function () {
                        disableScrollingLinks()
                    }, 100)
                })
            }, this, {priority: 1});
            onReady.onResize(".vw5-themeBoxesFooterLinks", function (el) {
                if ($(window).scrollTop() == 0 || el.parents(".vw5-frontend").height() <= $(window).height()) {
                    el.find(".vw5-themeBoxesFooterLinks__jumpToTop").addClass("disabled")
                }
            });


        }, {"jQuery": "jquery/dist/jquery.js", "kwf/on-ready": "kwf/commonjs/on-ready.js"}],
        "kwf/commonjs/cookie-opt.js": [function (require, module, exports) {
            var $ = require("jQuery");
        ...
        }, {"jQuery": "jquery/dist/jquery.js", "kwf/cookie-opt/adapter": "kwf/commonjs/cookie-opt/adapter.js"}],
        "kwf/commonjs/cookie-opt/adapter.js": [function (require, module, exports) {
            var $ = require("jQuery");
            ...
            "kwf/component-event": "kwf/commonjs/component-event.js"
        }],
        "kwf/commonjs/component-event.js": [function (require, module, exports) {
            ...
            module.exports = {
                trigger: function (evName) {
                    ...
                    componentEventHandlers[evName].push({cb: cb, scope: scope})
                }
            };
        ...
        "PoiTools_Kwc_CookieOptAdapter_Component-js": [function (require, module, exports) {
            var $ = require("jQuery");
            var onReady = require("kwf/on-ready");
            var cookieOpt = require("kwf/cookie-opt");
            var componentEvent = require("kwf/component-event");
            window["vw5-cookieOptCallback"] = function (api) {
                promise.resolve(api)
            };
            var cookieOptUrl;
            var promise;
            cookieOpt.setAdapter(function (p) {
                promise = p;
                $.getScript(cookieOptUrl)
            });
            onReady.onRender(".vw5-poiToolsKwcCookieOptAdapter", function (el) {
                cookieOptUrl = "//" + el.data("cookie-opt-domain") + "/api/v1/cookieopt.js?site=" + el.data("cookie-opt-site") + "&cb=vw5-cookieOptCallback"
            });
            ...
            "jQuery": "jquery/dist/jquery.js",
            "kwf/component-event": "kwf/commonjs/component-event.js",
            "kwf/cookie-opt": "kwf/commonjs/cookie-opt.js",
            "kwf/on-ready": "kwf/commonjs/on-ready.js"
        }],
        "Root_Domain_Component-master-js": [function (require, module, exports) {
            var $ = require("jQuery");
            var onReady = require("kwf/on-ready");
            var stickyContainer = null;
            var setScrollTopForFixedElements = function (el) {
                if (el.find(".vw5-rootDomainMaster__page").length && $(window).scrollTop() <= el.find(".vw5-rootDomainMaster__page").offset().top && $("body").hasClass("vw5-dealerPageV2")) {
                    var windowScrollTop = 0;
                    if ($(window).scrollTop() < 0) {
                        windowScrollTop = 0
                    } else {
                    ...
                    $.each(el.find(".vw5-moveOnCookieBanner"), function (i, elem) {
                        $(elem).css("top", el.find(".vw5-rootDomainMaster__page").offset().top - windowScrollTop).css("transition", "").addClass("vw5-visible")
                    })
                } else {
                    el.find(".vw5-moveOnCookieBanner").css("top", 0).addClass("vw5-visible")
                }
            ...
            var setScrollTopForFixedContainer = function () {
                ...
                if ($(window).scrollTop() < 0) {
                    $(".vw5-rootDomainMaster__content").hide().show(0)
                }
            };
            onReady.onRender(".vw5-rootDomainMaster", function (el) {
                stickyContainer = $(".vw5-rootDomainMaster__stickyContainer");
                $("body").prepend($(".vw5-statisticsOptBox"));
                if ($(window).width() >= 768) {
                    $(window).on("scroll", function () {
                        setScrollTopForFixedElements(el)
            ...
            onReady.onResize(".vw5-rootDomainMaster", function (el) {
                if (stickyContainer && stickyContainer.data("fixed-offset") == undefined) {
                    if (stickyContainer.length) {
                        stickyContainer.css("position", "relative");
                        stickyContainer.data("fixed-offset", stickyContainer.offset().top);
        ...
        "NewsletterSubscribeApi_Success_Component-js": [function (require, module, exports) {
            var onReady = require("kwf/on-ready");
            onReady.onRender(".vw5-newsletterSubscribeApiSuccess", function (el, config) {
        ...
        "Kwc_User_Login_Form_Success_Component-js": [function (require, module, exports) {
            var onReady = require("kwf/on-ready");
            onReady.onShow(".vw5-kwcUserLoginFormSuccess", function (el) {
        ...
        "kwf/commonjs/frontend-core.js": [function (require, module, exports) {
    ...
    }, {}, ["web/themes/Theme/Web.js", "Root_DomainAt_Component-master-js", "TextImage_Component-js", "Theme_BasicHeadline_Component-js", "Theme_BasicTable_Component-js", "Theme_FormDynamic_Paragraphs_Component-js", "Models_FindModel_Headline_Component-js", "E18_Embed_Component-js", "E18Legacy_Embed_Component-js", "Theme_Boxes_FooterLinks_Component-js", "PoiTools_Kwc_CookieOptAdapter_Component-js", "Root_Domain_Component-master-js", "NewsletterSubscribeApi_Success_Component-js", "Kwc_User_Login_Form_Success_Component-js", "kwf/commonjs/frontend-core.js"]);
    /*! modernizr 3.5.0 (Custom Build) | MIT *
 * https://modernizr.com/download/?-checked-cssanimations-csscalc-csstransforms-csstransforms3d-csstransitions-cssvwunit-flexbox-mediaqueries-touchevents-xhr2-mq-prefixed-setclasses-cssclassprefix:vw5- !*/
    !function (e, t, n) {
        function r(e, t) {
            return typeof e === t
        }
        ...
        function i() {
            ...
            for (var u in x) if (x.hasOwnProperty(u)) {
                ...
                for (i = r(t.fn, "function") ? t.fn() : t.fn, s = 0; s < e.length; s++) o = e[s], a = o.split("."), 1 === a.length ? Modernizr[a[0]] = i : (!Modernizr[a[0]] || Modernizr[a[0]] instanceof Boolean || (Modernizr[a[0]] = new Boolean(Modernizr[a[0]])), Modernizr[a[0]][a[1]] = i), w.push((i ? "" : "no-") + a.join("-"))
            }
        }
        ...
        function u(e, n, r, i) {
            var s, u, l, f, d = "modernizr", c = o("div"), p = a();
            if (parseInt(r, 10)) for (; r--;) l = o("div"), l.id = i ? i[r] : d + (r + 1), c.appendChild(l);
            return s = o("style"), s.type = "text/css", s.id = "s" + d, (p.fake ? p : c).appendChild(s), p.appendChild(c), s.styleSheet ? s.styleSheet.cssText = e : s.appendChild(t.createTextNode(e)), c.id = d, p.fake && (p.style.background = "", p.style.overflow = "hidden", f = S.style.overflow, S.style.overflow = "hidden", S.appendChild(p)), u = n(c, e), p.fake ? (p.parentNode.removeChild(p), S.style.overflow = f, S.offsetHeight) : c.parentNode.removeChild(c), !!u
        }
        ...
        function m(e, t, i, s) {
            ...
            for (var f, d, m, h, v, g = ["modernizr", "tspan", "samp"]; !P.style && g.length;) f = !0, P.modElem = o(g.shift()), P.style = P.modElem.style;
            for (m = e.length, d = 0; m > d; d++) if (h = e[d], v = P.style[h], l(h, "-") && (h = p(h)), P.style[h] !== n) {
                if (s || r(i, "undefined")) return a(), "pfx" == t ? h : !0;
                try {
                    P.style[h] = i
                } catch (y) {
                }
                if (P.style[h] != v) return a(), "pfx" == t ? h : !0
            }
            return a(), !1
        }
        ...
        function v(e, t, n) {
            var i;
            for (var s in e) if (e[s] in t) return n === !1 ? e[s] : (i = t[e[s]], r(i, "function") ? h(i, n || t) : i);
            return !1
        }

        function g(e, t, n, i, s) {
            var o = e.charAt(0).toUpperCase() + e.slice(1), a = (e + " " + z.join(o + " ") + o).split(" ");
            return r(t, "string") || r(t, "undefined") ? m(a, t, i, s) : (a = (e + " " + E.join(o + " ") + o).split(" "), v(a, t, n))
        }
        ...
        var x = [], C = {
            _version: "3.5.0",
            _config: {classPrefix: "vw5-", enableClasses: !0, enableJSClass: !0, usePrefixes: !0},
            _q: [],
            on: function (e, t) {
                var n = this;
                setTimeout(function () {
        ...
        var w = [], S = t.documentElement, b = "svg" === S.nodeName.toLowerCase(), _ = function () {
        ...
        C.mq = _;
        var T = "Moz O ms Webkit", z = C._config.usePrefixes ? T.split(" ") : [];
        C._cssomPrefixes = z;
        ...
        C._domPrefixes = E, C.testAllProps = g;
        var j = function (t) {
        ...
        C.prefixed = function (e, t, n) {
            return 0 === e.indexOf("@") ? j(e) : (-1 != e.indexOf("-") && (e = p(e)), t ? g(e, t, n) : g(e, "pfx"))
        };
        Modernizr.addTest("mediaqueries", _("only all")), C.testAllProps = y, Modernizr.addTest("csstransforms", function () {
            return -1 === navigator.userAgent.indexOf("Android 2.") && y("transform", "scale(1)", !0)
        }), Modernizr.addTest("flexbox", y("flexBasis", "1px", !0));
        var A = C.testStyles = u;
        Modernizr.addTest("checked", function () {
            return A("#modernizr {position:absolute} #modernizr input {margin-left:10px} #modernizr :checked {margin-left:20px;display:block}", function (e) {
                var t = o("input");
                return t.setAttribute("type", "checkbox"), t.setAttribute("checked", "checked"), e.appendChild(t), 20 === t.offsetLeft
            })
        });
        var L = C._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : ["", ""];
        C._prefixes = L, Modernizr.addTest("touchevents", function () {
            var n;
            ...
            return n
        }), Modernizr.addTest("cssanimations", y("animationName", "a", !0)), Modernizr.addTest("xhr2", "XMLHttpRequest" in e && "withCredentials" in new XMLHttpRequest), A("#modernizr { width: 50vw; }", function (t) {
            var n = parseInt(e.innerWidth / 2, 10), r = parseInt(d(t, null, "width"), 10);
            Modernizr.addTest("cssvwunit", r == n)
        }), Modernizr.addTest("csstransitions", y("transition", "all", !0));
        var N = "CSS" in e && "supports" in e.CSS, q = "supportsCSS" in e;
        Modernizr.addTest("supports", N || q), Modernizr.addTest("csstransforms3d", function () {
            ...
            var e = "width:", t = "calc(10px);", n = o("a");
            return n.style.cssText = e + L.join(t + e), !!n.style.length
        }), i(), s(w), delete C.addTest, delete C.addAsyncTest;
...
//# sourceMappingURL=/assets/dependencies/Kwf_Assets_Package_ComponentFrontend/Frontend/de/js.map?v=1500962684
